    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (choice == 4) {
                ...
                // Administrator statistics logic...
                continue;
            }
            ...
            while (true) {
                ...
                // Check if account balance is zero after any transaction
                if (accountBalance == 0) {
                    System.out.println("Your account balance is zero. Exiting account operations.");
                    break;
                }
            }
